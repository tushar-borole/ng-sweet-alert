...
(function () {
    ...
    function sweetalert_service($q) {
        function swal_alert(message, options) {
            return swal_confirm(message, angular.extend({ title:"Alert", text: message, type: "warning", showCancelButton : false }, options));
        }
        function swal_info(message, options) {
            return swal_alert(message, angular.extend({type:"info"}, options));
        }
        function swal_success(message, options) {
            return swal_alert(message, angular.extend({type:"success"}, options));
        }
        function swal_confirm(message, options) {
            var defered = $q.defer();
            var options = angular.extend({ title:"Alert", text: message, type: "warning", showCancelButton : true }, options);
